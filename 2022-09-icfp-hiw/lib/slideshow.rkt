...
(require (except-in pict cellophane file-icon)
         racket/contract
         racket/match
         slideshow/base
         slideshow/code
...
(define ((make-scaling-slide-assembler #:background-color [background-color "white"])
  ...
  (cc-superimpose background title+content))
...
(define current-item-indent (make-lazy-parameter em))
